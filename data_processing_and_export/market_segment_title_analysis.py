...
writer = create_excel_writer(f"{conference_name} GP - Market Segment & Title Analysis - 2024.xlsx", False, save_directory)
writer = pd.ExcelWriter(f"{conference_name} GP - Market Segment & Title Analysis - 2024.xlsx", engine='xlsxwriter')
